...
<table class="table table-responsive mt-auto">
                <thead>
                <tr>
                    <td colspan="12" scope="col" class="table-dark text-center font-weight-bold">Registros de alumnos.</td>
                    <td colspan="1" scope="col" class="table-dark text-center font-weight-bold">
                        <a class="nav-link text-light font-a-a" href="php/generatePDF.php?id=<?php echo $id_cc;?>" target="_blank">
